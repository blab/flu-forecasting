...
%DIF ADD manuscript/flu_forecasting.tex                   Thu Aug  6 10:29:22 2020
...
\begin{figure}[htb]
  \begin{center}
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\columnwidth]{figures/distance-based-fitness-model.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\columnwidth]{figures/Figure_1.pdf}
  \DIFaddendFL \caption{
...
\begin{figure}[htb]
  \begin{center}
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{figures/unadjusted-model-accuracy-and-coefficients-for-simulated-populations-controls.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/Figure_2.pdf}
  \DIFaddendFL \caption{
...
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/unadjusted-model-accuracy-and-coefficients-for-simulated-populations.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/Figure_3.pdf}
  \DIFaddendFL \caption{
...
\DIFdelendFL \DIFaddbeginFL 
  ...
  \figsupp[Composite model coefficients and distances to the future for models fit to simulated populations.]{
    A) Coefficients and B) distances are shown per validation timepoint and test timepoint as in Figure~\ref{fig:unadjusted_model_accuracy_and_coefficients_for_simulated_populations_controls}.}{\includegraphics[width=\textwidth]{figures/Figure_3-Figure_supplement_1.pdf}}\label{figsupp:unadjusted_composite_model_accuracy_and_coefficients_for_simulated_populations}
...
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/validation_figure_simulated-simulated_sample_3_test_tree-normalized_fitness.pdf}
%DIFDELCMD <   %%%
...
\DIFdelendFL \DIFaddbeginFL 
  ...
  C) Absolute forecast error for clades shown in A by their initial frequency with a mean LOESS fit (solid black line) and 95\% confidence intervals (gray shading) based on 100 bootstraps.
  D) The correlation of all strains at all timepoints by the percentile rank of their observed and estimated distances to the future.
  The corresponding results for the naive model are shown in Figure~\ref{fig:test_of_best_model_for_simulated_populations}-Figure supplement~\ref{figsupp:validation_of_naive_model_for_simulated_populations}.}{\includegraphics[width=\textwidth]{figures/Figure_4-Figure_supplement_1.pdf}}\label{figsupp:validation_of_best_model_for_simulated_populations}

  \figsupp[Validation of naive model for simulated populations of H3N2-like viruses.]{
    Note that the naive model sets future frequencies to current frequencies such that there is no estimated fold change in frequencies for the first panel.}{\includegraphics[width=\textwidth]{figures/Figure_4-Figure_supplement_2.pdf}}\label{figsupp:validation_of_naive_model_for_simulated_populations}

  \figsupp[Test of naive model for simulated populations of H3N2-like viruses.]{
    Note that the naive model sets future frequencies to current frequencies such that there is no estimated fold change in frequencies for the first panel.}{\includegraphics[width=\textwidth]{figures/Figure_4-Figure_supplement_3.pdf}}\label{figsupp:test_of_naive_model_for_simulated_populations}
...
\begin{figure}[htb]
  \DIFdelbeginFL %DIFDELCMD < \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/unadjusted-model-accuracy-and-coefficients-for-natural-populations.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/Figure_5.pdf}
  \DIFaddendFL \caption{
...
\DIFdelendFL \DIFaddbeginFL 
  ...
  \figsupp[Comparison of epitope-based models with knowledge of the future.]{
    ...
    The improved performance of the ``oracle'' model indicates that the sequence-based antigenic novelty metric can be effective when sites of beneficial mutations are known prior to forecasting.}{\includegraphics[width=\textwidth]{figures/Figure_5-Figure_supplement_1.pdf}}\label{figsupp:unadjusted_composite_model_accuracy_and_coefficients_for_natural_populations_epitope_vs_oracle}
...
\begin{figure}[htb]
  \DIFdelbeginFL %DIFDELCMD < \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/best-composite-unadjusted-model-accuracy-and-coefficients-for-natural-populations.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/Figure_6.pdf}
  \DIFaddendFL \caption{
...
\DIFdelendFL \DIFaddbeginFL 
  ...
  \figsupp[Composite models fit to most recent data from natural populations.]{
    ...
    The naive model's distance to the future was 6.82 $\pm$ 1.74 AAs for these timepoints.}{\includegraphics[width=\textwidth]{figures/Figure_6-Figure_supplement_1.pdf}}\label{figsupp:updated_model_accuracy_and_coefficients_for_natural_populations_across_test_data}
...
\DIFdelbegin %DIFDELCMD < \begin{figure}[p]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/validation_figure_natural-natural_sample_1_with_90_vpm_sliding_test_tree-cTiter_x-ne_star.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \begin{figure}
...
\DIFdelendFL \DIFaddbeginFL 
  ...
  \figsupp[Validation of best model for natural populations of H3N2 viruses.]{
    Validation results for the composite model of mutational load and LBI.
    A) The correlation of estimated and observed clade frequency fold changes shows the model's ability to capture clade-level dynamics without explicitly optimizing for clade frequency targets.
    ...
    C) Absolute forecast error for clades shown in A by their initial frequency with a mean LOESS fit (solid black line) and 95\% confidence intervals (gray shading) based on 100 bootstraps.
    D) The correlation of all strains at all timepoints by the percentile rank of their observed and estimated distances to the future.
    The corresponding results for the naive model are shown in Figure~\ref{fig:test_of_best_model_for_natural_populations}-Figure supplement~\ref{figsupp:validation_of_naive_model_for_natural_populations}.}{\includegraphics[width=\textwidth]{figures/Figure_7-Figure_supplement_1.pdf}}\label{figsupp:validation_of_best_model_for_natural_populations}

  \figsupp[Validation of naive model for natural populations of H3N2 viruses.]{
    Note that the naive model sets future frequencies to current frequencies such that there is no estimated fold change in frequencies for the first panel.}{\includegraphics[width=\textwidth]{figures/Figure_7-Figure_supplement_2.pdf}}\label{figsupp:validation_of_naive_model_for_natural_populations}

  \figsupp[Test of naive model for natural populations of H3N2 viruses.]{
    Note that the naive model sets future frequencies to current frequencies such that there is no estimated fold change in frequencies for the first panel.}{\includegraphics[width=\textwidth]{figures/Figure_7-Figure_supplement_3.pdf}}\label{figsupp:test_of_naive_model_for_natural_populations}
...
The estimated best strain from this model was in the top first percentile of observed closest strains for half of the validation timepoints and in the top 20th percentile for 100\% of timepoints (\DIFdelbegin \DIFdel{Fig.}\DIFdelend \DIFaddbegin \DIFadd{Figure}\DIFaddend ~\ref{fig:test_of_best_model_for_natural_populations}B).
...
\begin{figure}[htb]
  \DIFdelbeginFL %DIFDELCMD < \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/vaccine-comparison.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/Figure_8.pdf}
  \DIFaddendFL \caption{
...
\DIFdelendFL \DIFaddbeginFL 
  ...
  \figsupp[Relative improvement of model selections over vaccine strains.]{
    Relative distance to future H3N2 populations between vaccine strains and corresponding observed and estimated best strains at each timepoint as in Figure~\ref{fig:vaccine_comparison}.
    Strains with relative distances greater than zero were farther from the future than the selected vaccine strain, while strains below zero were closer to the future.}{\includegraphics[width=\textwidth]{figures/Figure_8-Figure_supplement_1.pdf}}\label{figsupp:vaccine_comparison_relative_distance}
\DIFaddendFL \end{figure}
...
The mutational load and LBI model selected strains that were as close or closer to the future than the corresponding vaccine strain for 10 (83\%) of the 12 seasons with vaccine updates (\DIFdelbegin \DIFdel{Fig.
...
\begin{figure}[htb]
  \begin{center}
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{figures/nextstrain-forecasts.png}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/Figure_9.png}
  \DIFaddendFL \caption{
...
\begin{figure}[htb]
  \begin{center}
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{figures/nextstrain-weighted-distance-to-future-per-strain.png}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/Figure_10.png}
  \DIFaddendFL \caption{
...
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/cross-validation-for-simulated-populations.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/simulated-h3n2-ha-phylogeny.png}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/unadjusted-composite-model-accuracy-and-coefficients-for-simulated-populations.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/bootstrap_distributions_for_simulated_sample_3.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/validation_figure_simulated-simulated_sample_3-normalized_fitness.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/validation_figure_simulated-simulated_sample_3-naive.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/validation_figure_simulated-simulated_sample_3_test_tree-naive.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/cross-validation-for-natural-populations.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/unadjusted-composite-model-accuracy-and-coefficients-for-natural-populations-epitope-vs-oracle.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/bootstrap_distributions_for_natural_sample_1_with_90_vpm_sliding.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/validation_figure_natural-natural_sample_1_with_90_vpm_sliding-ne_star-lbi.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/validation_figure_natural-natural_sample_1_with_90_vpm_sliding-naive.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/validation_figure_natural-natural_sample_1_with_90_vpm_sliding_test_tree-naive.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[H]
%DIFDELCMD <   \begin{center}
%DIFDELCMD <   \includegraphics[width=\textwidth]{figures/models-natural-populations-composite-with-updated-coefficients-across-test-data.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
