...
\author[3]{Seiichiro Fujisaki}
\author[3]{Kazuya Nakamura}
\author[3]{Noriko Kishida}
\author[3]{Shinji Watanabe}
\author[3]{Hideki Hasegawa}
\author[4]{John Barnes}
\author[4]{Thomas Rowe}
\author[4]{Xiyan Xu}
\author[4]{Rebecca Kondor}
\author[4]{David E. Wentworth}
\author[5,6]{Richard A.\ Neher}
\author[1]{Trevor Bedford}

\affil[1]{Vaccine and Infectious Disease Division, Fred Hutchinson Cancer Research Center, Seattle, WA, USA}
\affil[2]{Molecular and Cell Biology, University of Washington, Seattle, WA, USA}
\affil[3]{Influenza Virus Research Center, National Institute of Infectious Diseases, Tokyo, Japan}
\affil[4]{Virology Surveillance and Diagnosis Branch, Influenza Division, National Center for Immunization and Respiratory Diseases (NCIRD), Centers for Disease Control and Prevention (CDC), 1600 Clifton Road, Atlanta, GA 30333, USA}
\affil[5]{Biozentrum, University of Basel, Basel, Switzerland}
\affil[6]{Swiss Institute of Bioinformatics, Basel, Switzerland}
