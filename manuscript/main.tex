...
\begin{figure*}[ht]
  ...
  \caption{
    ...
    \tbc{I'd label left and right columns as `Forecast' and `Retrospective' of something to this effect.}
  }
  \label{fig:model}
  \end{center}
\end{figure*}
...
\tbc{I'd generally use the term `fitness model' instead of `exponential growth' model. Exponential growth makes me think of actual exponential growth rather than Malthusian growth.}
...
\rnc{A paragraph explaining the metrics would help.}
...
\tbc{Include figure showing predicted match of strains to future population. Possibly compare Hamming match to FRA match.}
