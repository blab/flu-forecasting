...
\begin{figure*}[ht]
  ...
  \caption{
    Snapshot of live forecasts on nextstrain.org from our best model (HI cross-immunity and mutational load) for January 2021.
...
\begin{figure*}[ht]
  ...
  \caption{
    ...
    Distance to the future is calculated for each sample as the Hamming distance of HA amino acid sequences to all other circulating strains weighted by the other sample's projected frequencies under the best fitness model (HI cross-immunity and mutational load).
  }
