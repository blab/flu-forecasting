...
These results are consistent with the observed dynamics of A/H3N2.
First, the one-year forecast horizon is a fraction of the average coalescence time for A/H3N2 populations of about 3--8 years \cite{}.
Hence, we expect the diversity of circulating strains to persist between seasons.
Second, the average substitution rate for A/H3N2's HA is 0.0043 substititions per site per year or an average accumulation of 2.4 AAs per year.
...
This modest improvement over the naive model highlights the inherent difficulty and potentially limited ability to make precise forecasts for such a complex, dynamical system with the current framework.
