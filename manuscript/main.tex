...
\subsection*{Practical recommendations for forecasting}

The best model in the validation period got 0.96 AAs closer to the future than the naive model.
The best model in the test period got 0.66 AAs closer to the future on average.
At a historical substitution rate of 0.0043 substitutions per site per year, we anticipate an average accumulation of 2.4 AAs per season.
