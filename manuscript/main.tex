...
A standard expectation from machine learning is that models will perform worse on test data than on validation data due to overfitting to training data.
...
The resulting empirical distribution values less than zero when the first model outperformed the second model.
