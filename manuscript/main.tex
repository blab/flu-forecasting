...
Inspired by the original approach of Shih et al. \cite{Shih:2007bd}, we identified 25 sites in HA1 where mutations rapidly swept through the global population.
Only 12 (48\%) of these sites also appeared in {\L}uksza and L\"assig's \cite{Luksza:2014hj} original set of 49 sites.
We fit a cross-immunity model to these 25 sites across the complete validation period and dubbed this the ``oracle cross-immunity'' model, as it benefitted from knowledge of the future in its forecasts.
