...
rule run_fitness_model:
    ...
    shell: "python fit_model.py {input.ha_tree} {input.frequencies} {output} {params.predictor_list} --na-tree {input.na_tree} --titers {input.titers} --dms {SNAKEMAKE_DIR}/{input.dms} &> {log}"
